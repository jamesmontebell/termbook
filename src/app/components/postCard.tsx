...
export default function PostCard({ journal }: JournalEntryProps) {
  ...
  return (
    <Card className="bg-slate-950 sm:w-[300px] border border-slate-700 rounded-2xl shadow-md shadow-cyan-400/30 flex flex-col hover:shadow-lg hover:shadow-cyan-400/30 transition duration-500 ease-in-out transform hover:scale-105 hover:z-50">
      <CardHeader className="">
        <CardTitle className="text-white">
          {journal.time.split("T")[0]}
        </CardTitle>
      </CardHeader>
      <CardDescription className="text-white w-full text-xl p-5 h-[180px] overflow-hidden">
        {journal.content}
      </CardDescription>
