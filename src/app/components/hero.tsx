        ...
        <div className="pt-20">
            <Particles className="absolute inset-0 -z-10" />
                <div className="text-center px-8">
                    ...
                    <p className="mb-8 text-lg text-zinc-300/40 font-medium" data-aos="fade-down" data-aos-delay="200">Alleviate Stress Through Journaling, this time we WON'T let you quit</p>
