...
export default function Page() {
  ...
  What is <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-fuchsia-300 to-fuchsia-300">Termbook</span>?
</h2>
          <p className="pb-4 text-lg text-white tracking-wide leading-loose my-2">
          Termbook is a complete journaling system built to keep developers on their journaling journey. Each time
          you open your terminal - you will be propmted to enter a journal entry for the day (unless you already have). Our CLI program will force you to write at least 50 words so you can unburden and reflect.
          The website, which you're on now, was constructed to be an easy way to access and view all your previous entries. Easily sign-up / sign-in via your GitHub account. We have fantastic <u><Link href="/docs" className="bg-clip-text text-transparent bg-gradient-to-r from-cyan-300 via-cyan-400 to-cyan-200 font-semibold">docs</Link></u> and cross-platform support so no matter who you are, or where you are, you can join our community of journaling enthusiasts.
          </p>
          <h2 className="pb-2 text-3xl font-bold text-transparent bg-gradient-to-r bg-clip-text from-cyan-300 via-cyan-50 to-cyan-50">
  The Inspiration Behind <span className="text-transparent bg-clip-text bg-gradient-to-l from-fuchsia-300 via-fuchsia-300 to-cyan-300">Termbook</span>
</h2>
          <p className="pb-4 text-lg text-white tracking-wide leading-loose my-1">
          Our team has experienced first hand just how much of a difference journaling can make in your daily mood. From stress relief, to self reflection, to improved ability to communicate and express ourselves - the benefits of journaling are incredible. But it can be very hard for busy CS students and developers to remember to journal - even if it would greatly benefit their mental health. 
          </p>
          </div>
        </article>
      </div>
