...
In your terminal setup file (.zshrc, .bashrc, .bash_profile, profile.ps1, etc.) find the command you inserted during setup that contains the file termbook_<yourplatoformhere> and delete it.
