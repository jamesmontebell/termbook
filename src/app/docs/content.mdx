...
- Click: 
```bash
Copy "Termbook-YourSystem.exe" as Pathname
```
- This will copy the full path for the file to your clipboard.
- In your terminal window, type:
```bash
chmod u+x /path/to/Termbook-YourSystem.exe
```
- Make sure to replace the path with the actual path where you have downloaded and made 'Termbook-YourSystem.exe' executable
...
```bash
/home/user/downloads/Termbook-LinuxVersion.exe
```
...
```bash
./path/to/your/Termbook-YourSystem.exe
```
